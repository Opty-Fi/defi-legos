...
interface ICurve3MaticStableSwapMetapoolFactory {
    ...
    function add_liquidity(uint256[3] memory _amounts, uint256 _min_mint_amount) external payable returns (uint256);
